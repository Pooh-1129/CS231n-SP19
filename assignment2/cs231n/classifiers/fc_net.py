...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dh, grads['W2'],grads['b2'] = affine_backward(dx, cache2)
        ...
        for i in reversed(range(self.num_layers)):
            ...
            if i == self.num_layers - 1:
                ...
                if self.normalization is None:
                    ...
                    dx, grads[w], grads[b], grads[g], grads[beta] = affine_bn_relu_backward(dx, caches.pop())
                elif self.normalization == 'layernorm':
                    dx, grads[w], grads[b], grads[g], grads[beta] = affine_ln_relu_backward(dx, caches.pop())
